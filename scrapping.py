...
class IMDb:
    ...
    def getEndYear(self, imdb_id, details=None):
        try:
            details = IMDb.getDetails(self, imdb_id, details)
            return details["props"]["pageProps"]["aboveTheFoldData"]["releaseYear"]["endYear"]
        except:
            return ""
    ...
    def getRuntime(self, imdb_id, details=None, seconds=False):
        try:
            details = IMDb.getDetails(self, imdb_id, details)
            return details["props"]["pageProps"]["aboveTheFoldData"]["runtime"]["seconds"]
        except:
            return ""
    ...
    def getEpisodes(self, imdb_id, details=None):
        try:
            details = IMDb.getDetails(self, imdb_id, details)
            return details["props"]["pageProps"]["mainColumnData"]["episodes"]["episodes"]["total"]
        except:
            return ""

    def getSeason(self, imdb_id, details=None):
        try:
            details = IMDb.getDetails(self, imdb_id, details)
            return details["props"]["pageProps"]["mainColumnData"]["episodes"]["seasons"][-1]["number"]
        except:
            return ""

    def getPlot(self, imdb_id, details=None):
        try:
            details = IMDb.getDetails(self, imdb_id, details)
            return details["props"]["pageProps"]["aboveTheFoldData"]["plot"]["plotText"]["plainText"]
        except:
            return ""
    ...
    def getFeatures(self, imdb_id, seconds=False, InList=False, name_id=False):
        ...
        if details != "":
            ...
            features["end_year"] = IMDb.getEndYear(self, imdb_id, details)
            features["episodes"] = IMDb.getEpisodes(self, imdb_id, details)
            features["seasons"] = IMDb.getSeason(self, imdb_id, details)
            features["plot"] = IMDb.getPlot(self, imdb_id, details)
    ...
    def getMedia(self, imdb_id):
        ...
        if details != "":
            ...
            media["end_year"] = IMDb.getEndYear(self, imdb_id, details)
        ...
        if details is not None:
            ...
            if source != "":
                try:
                    ...
                    print("Sayfayi çekerken hata oluştu")
                    return ""
            else:
                return ""
    ...
    def getPage(url):
        ...
        try:
            ...
            source = BeautifulSoup(resp.replace("&apos;", "'").replace("&quot;", '"').replace(
                "&gt;", ">").replace("&lt;", "<").replace("&amp;", "&"), "html.parser")
            return source
        except:
            print("Internet hatasi")
            return ""
...
tst = pd.DataFrame(result)
tst.to_csv('Veri_dizi_1998_2023.csv')
